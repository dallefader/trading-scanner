...
st.set_page_config(page_title="Trading Terminal Pro v3.5", page_icon="🟢",
...
def main():
    ...
    # SIDEBAR – fjernet, opdater-knap flyttes til header
    show_wl  = False
    only_s2  = False
    ...
    # Opdater-knap placeret øverst til højre
